...
public class ModelTricksyFoxCrouching<T extends EntityTricksyFox> extends ModelTricksyFoxBase<T>
{
	...
	public static TexturedModelData getTexturedModelData(float inflation)
	{
		...
		tail.addChild("tail1", ModelPartBuilder.create().uv(30, 0).cuboid(-3.0F, -0.5F, -3.0F, 4.0F, 9.0F, 5.0F, dilation), ModelTransform.of(0.0F, 0.1736F, 0.9848F, 1.5708F, -0.6109F, 0.0F));
		tail.addChild("tail0", ModelPartBuilder.create().uv(30, 0).cuboid(-1.0F, -0.5F, -3.0F, 4.0F, 9.0F, 5.0F, dilation), ModelTransform.of(0.0F, 0.1736F, 0.9848F, 1.5708F, 0.6109F, 0.0F));
		...
		root.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(4, 24).mirrored().cuboid(-2.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, dilation).mirrored(false), ModelTransform.pivot(-1.0F, 18.0F, -4.5F));
		root.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(4, 24).cuboid(0.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, dilation), ModelTransform.pivot(1.0F, 18.0F, -4.5F));
		
		return TexturedModelData.of(meshdefinition, 48, 32);
	}
	
	// TODO Correct pivot points to match vanilla fox
