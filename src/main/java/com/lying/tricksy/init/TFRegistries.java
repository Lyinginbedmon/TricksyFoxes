...
{
	public static final RegistryKey<Registry<Accomplishment>> ACC_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("accomplishment"));
	public static final Registry<Accomplishment> ACC_REGISTRY = FabricRegistryBuilder.createSimple(ACC_KEY).buildAndRegister();
	
	public static final RegistryKey<Registry<BoardType>> BOARD_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("whiteboard_type"));
	public static final Registry<BoardType> BOARD_REGISTRY = FabricRegistryBuilder.createSimple(BOARD_KEY).buildAndRegister();
	
	public static final RegistryKey<Registry<TFObjType<?>>> OBJ_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("object_type"));
	public static final Registry<TFObjType<?>> OBJ_REGISTRY = FabricRegistryBuilder.createSimple(OBJ_KEY).buildAndRegister();
	
	public static final RegistryKey<Registry<NodeType<?>>> TYPE_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("node_supertype"));
	public static final Registry<NodeType<?>> TYPE_REGISTRY = FabricRegistryBuilder.createSimple(TYPE_KEY).buildAndRegister();
	
	public static final RegistryKey<Registry<TFNodeStatus>> STATUS_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("node_status"));
	public static final Registry<TFNodeStatus> STATUS_REGISTRY = FabricRegistryBuilder.createSimple(STATUS_KEY).buildAndRegister();
	
	public static final RegistryKey<Registry<TFSpecialVisual>> VISUAL_KEY = RegistryKey.ofRegistry(Reference.ModInfo.prefix("special_visual"));
