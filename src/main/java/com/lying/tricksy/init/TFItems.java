...
public class TFItems
{
    ...
    public static final ItemGroup TRICKSY_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(SAGE_HAT)).displayName(Reference.ModInfo.translate("itemGroup", "item_group")).entries((ctx,entries) -> 
	    {
