...
public class ModelOnryoji<T extends EntityOnryoji> extends SinglePartEntityModel<T> implements ModelWithHead
{
	...
	public ModelOnryoji(ModelPart data)
	{
		...
		this.upperBody = body.getChild("upper");
		this.lowerBody = body.getChild("lower");
	...
	public static TexturedModelData createBodyLayer(float dil)
	{
		...
		ModelPartData upper = body.addChild("upper", ModelPartBuilder.create().uv(0, 12).cuboid(-3.0F, -5.0F, -3.0F, 6.0F, 5.0F, 6.0F, dilation)
		...
		// TODO Use ModelUtils.cuboid to exclude DOWN face of sleeves, to improve arm visibility
		upper.addChild(EntityModelPartNames.LEFT_ARM, ModelPartBuilder.create().uv(24, 12).mirrored().cuboid(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, dilation).mirrored(false)
				.uv(32, 12).mirrored().cuboid(0.0F, -1.0F, -0.75F, 2.0F, 6.0F, 2.0F, dilation.add(0.5F)).mirrored(false), ModelTransform.of(3.0F, -3.0F, -0.5F, -0.8727F, 0.0F, -0.6109F));
		
		upper.addChild(EntityModelPartNames.RIGHT_ARM, ModelPartBuilder.create().uv(24, 12).cuboid(-2.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, dilation)
				.uv(32, 12).cuboid(-2.0F, -1.0F, -0.75F, 2.0F, 6.0F, 2.0F, dilation.add(0.5F)), ModelTransform.of(-3.0F, -3.0F, -0.5F, -0.8727F, 0.0F, 0.6109F));
		
		ModelPartData lower = body.addChild("lower", ModelPartBuilder.create().uv(0, 23).cuboid(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, dilation)
		.uv(0, 46).cuboid(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, dilation.add(0.25F)), ModelTransform.pivot(0.0F, -7.0F, 1.0F));
		
		ModelPartData legs = lower.addChild("legs", ModelPartBuilder.create(), ModelTransform.of(0.0F, 0.5F, -0.5F, 0.2182F, 0.0F, 0.0F));
