...
public class SyncInventoryScreenReceiver implements ClientPlayNetworking.PlayChannelHandler
{
	public void receive(MinecraftClient client, ClientPlayNetworkHandler handler, PacketByteBuf buf, PacketSender responseSender)
	{
		...
		client.execute(() -> 
		{
			...
			if(syncId == screenHandler.syncId && screenHandler instanceof TricksyInventoryScreenHandler)
			{
				TricksyInventoryScreenHandler screen = (TricksyInventoryScreenHandler)screenHandler;
